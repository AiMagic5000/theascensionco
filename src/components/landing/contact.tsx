      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">(888) 868-8069</p>
                  </div>
                </a>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">support@theascensionco.us</p>
                  </div>
                </a>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <form className="bg-gray-50 rounded-2xl p-8 border border-gray-200">
              <h3 className="text-xl font-semibold text-gray-900 mb-6">
                Send Us a Message
              </h3>
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <select className="flex h-10 w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="flex w-full rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm placeholder:text-gray-500 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500"
                  />
                </div>
